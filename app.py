...
if prompt := st.chat_input("Ask me anything!"):
    ...
    with st.chat_message("assistant"):
        ...
        def app_response(result):
            ...
            # Get valid parameters for BaseLlmConfig
            valid_params = inspect.signature(BaseLlmConfig.__init__).parameters.keys()
            # Filter llm_config to include only valid parameters
            filtered_llm_config = {key: value for key, value in llm_config.items() if key in valid_params}
            config = BaseLlmConfig(**filtered_llm_config)
